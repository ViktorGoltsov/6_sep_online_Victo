...
//          System.out.println(arrayOfIntegers[3]);
    ...
    public void MyHostelPayCalc(int NumOfNights, int NumOfGuests, int NumOfBreakfasts) {

    int PrisePerPerson = 20;
    int PrisePerBreacfast = 5;
        int SumOfPay = (NumOfGuests*PrisePerPerson+NumOfBreakfasts*PrisePerBreacfast)*NumOfNights;
    String TotalCheck = ("Your total Pay for " +NumOfNights+" nights staying "+NumOfGuests +" Guests: "+SumOfPay+" $");
        System.out.println(TotalCheck);
    }

    @Test
    public void testInfoFromGuest() {
    MyHostelPayCalc(4,3,2);
    }
}
